params <-
list(Obj = "x", projectName = "x", cfs = "x", output.cutoff = "x", 
    group = "x")
...
## ----Cell_qc_a, echo = FALSE, warning=FALSE-----------------------------------
pd<-pData(eset)
...
## ---- fig.width=10, fig.height=6 ,echo=FALSE----------------------------------
p.cell.1

## ----Cell_qc_b, echo=FALSE, warning=FALSE-------------------------------------
...
## ----Output Basic statistics, echo=FALSE--------------------------------------
...
## ----Calc_cell_cutoff, echo=FALSE,results='asis'------------------------------
if (params$output.cutoff){
