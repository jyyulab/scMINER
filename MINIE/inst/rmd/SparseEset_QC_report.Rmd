...
sample_info_c1 <- c("Sample ID", "Output Directory", "Raw Genes", "Raw Cells", "Median cells per gene")
...
nCell_cutoff <- max(floor(0.005 * dim(d)[2]), 1)
...
#Compute suggested filtering criteria for cells 
