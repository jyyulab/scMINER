...
activity_B.eset <- getActivity_individual(input_eset = pbmc14k_log2cpm.eset[, pData(pbmc14k_log2cpm.eset)$true_label.new == "B"], network_file.tf = "/work-path/PBMC14K/SJARACNe/B/TF/bt100_pc001/consensus_network_ncol_.txt", network_file.sig = "/work-path/PBMC14K/SJARACNe/B/SIG/bt100_pc001/consensus_network_ncol_.txt", driver_type = "TF_SIG")
```
...
```{r save-activity-eset, echo=FALSE}
