---
layout: default
title: Complemantary guidance with PBMC(12k) 
nav_order: 3
---
...
First, after clustering via MICA, you can load MICA output (in .txt) as well as input expression matrix in R under an expressionSet. This is going to be the major data structure we used for MINIE analysis in R.
...
Or you can visualize top master regulator candidates in heatmap. Only png as plotting device is supported.
